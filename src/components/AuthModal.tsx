    ...
    if (!res.success) {
      setErrorMsg(
        res.error?.includes('rate')
          ? 'Supabase shared email limit reached. Use Password Login or Demo Login below, or connect custom SMTP.'
          ...
          >
            ...
            <div className="lg:col-span-7 p-6 sm:p-8 flex flex-col justify-between bg-gradient-to-b from-[#F7F4EC] via-[#EFEBE0] to-[#E5DFCFC0]">
              <div>
                ...
                {/* Tab Switcher */}
                <div className="flex p-1 bg-black/5 rounded-xl mb-3">
                  <button
                    type="button"
                    onClick={() => {
                      setAuthMode('login');
                ...
                {/* Method Switcher */}
                <div className="flex items-center justify-center gap-3 mb-3 text-[11px] font-semibold">
                  <button
                    type="button"
                    onClick={() => {
                      setMethod('password');
                    ...
                    className={`pb-0.5 border-b-2 cursor-pointer ${
                      method === 'password' ? 'border-[#2563EB] text-[#2563EB] font-bold' : 'border-transparent text-slate-500'
                    }`}
                  >
                    Password (Instant)
                  </button>
                  ...
                  <button
                    ...
                    className={`pb-0.5 border-b-2 cursor-pointer ${
                      method === 'otp' ? 'border-[#2563EB] text-[#2563EB] font-bold' : 'border-transparent text-slate-500'
                    }`}
                  >
                    Email OTP Code
                  </button>
                ...
                {errorMsg && (
                  <div className="mb-3 p-2 rounded-xl bg-rose-50 border border-rose-200 text-rose-800 text-xs flex items-start gap-1.5">
                ...
                {successMsg && (
                  <div className="mb-3 p-2 rounded-xl bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs flex items-start gap-1.5">
                ...
                <div className="mt-4 pt-3 border-t border-black/10">
                  ...
                  <div className="grid grid-cols-3 gap-1.5">
                    <button
                      ...
                      className="py-1 px-1.5 rounded-lg bg-white/80 hover:bg-white text-[10px] font-semibold text-slate-800 border border-black/10 shadow-2xs cursor-pointer text-center"
                    >
                      🎓 Student
                    </button>
                    <button
            ...
            <div className="hidden lg:flex lg:col-span-5 bg-[#0E131F] text-white flex-col justify-between p-8 relative overflow-hidden">
              ...
              <div className="relative z-10 text-[10px] text-slate-400 font-mono">
                <ShieldCheck size={12} className="inline mr-1 text-[#2563EB]" />
                Supabase 256-bit Security
              </div>
            </div>
          </motion.div>
        </div>
